...
4. Energy findings are implementation- and hardware-dependent. FastV did not show consistent energy savings across the three workload draws despite high dense avoidance.
